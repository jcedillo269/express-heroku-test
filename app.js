...
/**
 * http://auduo-backend.herokuapp.com/callback
...
app.get('/login', function(req, res) {
  ...
  var scope = 'user-read-private user-read-email playlist-read-private playlist-read-collaborative user-read-playback-state'; //come here to add scopes or permissions that our app can see from user
